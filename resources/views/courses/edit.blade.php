...
@section('body')
    ...
    <div class="card col-lg-12" style="width: 90%; margin-left: 44px;">
        ...
        <div class="card-body card-block">
            <form action="{!! url('update_courses') !!}" method="post" enctype="multipart/form-data" class="form-horizontal">
                @csrf
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <select class="form-control" name="center_id" required>
                            ...
                            <option value="{!! $center->id !!}" @if($missionById->status==$center->id)selected @endif>{!! $center->name ?? ''  !!}</option>
                            @empty
                            @endforelse
                        </select>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="hidden" name="id" value="{!! $missionById->id !!}">
                        <input type="text" id="text-input" name="name" placeholder="Enter name" class="form-control" required value="{!! $missionById->name ?? ''  !!}">
                        <span class="text-danger">{!! $errors->has('name')? $errors->first('name'):'' !!}</span>
                    </div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="file" id="text-image" name="image" placeholder="Enter image" class="form-control" >
                        <span class="text-danger">{!! $errors->has('image')? $errors->first('image'):'' !!}</span>
                        <br>
                        <img src="/images/{!! $missionById->image ?? ''  !!}" id="course_image" style="height: 150px;width: 150px;">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-3">
                    ...
                    <div class="col-12 col-md-9">
                        ...
                        <textarea name="short_description" class="form-control textarea" placeholder="short_description">
                            {!! $missionById->short_description ?? '' !!}
                        </textarea>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        ...
                        <textarea name="details" class="form-control textarea" placeholder="Details">{!! $missionById->details !!}</textarea>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="date" name="start_date" class="form-control" placeholder="start_date" value="{!! $missionById->start_date !!}">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="date" name="end_date" class="form-control" placeholder="end_date" value="{!! $missionById->end_date !!}">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <input type="number" name="fee" class="form-control" placeholder="fee" value="{!! $missionById->fee ?? 0 !!}">
